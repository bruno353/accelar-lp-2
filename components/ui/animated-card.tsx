...
export function CardDemo() {
  return (
    <Card>
      ...
      <CardTitle>Several options</CardTitle>
      <CardDescription>
        Build your automations from a range of LLM providers
      </CardDescription>
    </Card>
  );
}
...
const Container = ({
  ...
  return (
    <div
      className={cn(
        `h-16 w-16 rounded-full flex items-center justify-center bg-[rgba(89,89,89,0.01)]
